...
def main(mode, experiment_path, inference_file):
    ...
    parser.add_argument('--mode', type=str, default=mode, choices=['train', 'test', 'train_test', 'inference'])
    parser.add_argument('--data_path', type=str, default='./data/emotic_pre', help='Path to preprocessed data npy files/ csv files')
    ...
    parser.add_argument('--inference_file', default=inference_file, type=str, help='Text file containing image context paths and bounding box')
...
if __name__ =='__main__':
    main('train', 'debug_exp', 'sample_inference_list.txt')